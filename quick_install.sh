...
sh_packages="git aria2 node python3 nload lftp tmux zsh tree wget wine freetype p7zip cmake rsync youtube-dl sqlite coreutils gcc pv mpv htop avr-gcc nmap z iperf ntfs-3g pass"
brew install $sh_packages
brew upgrade $sh_packages

apps="libreoffice libreoffice-language-pack google-chrome firefox slack macdown sublime-text messenger cerebro telegram-desktop cd-to arduino vlc teensy tunnelblick karabiner-elements iterm2 nally appcleaner wireshark microsoft-office nordic-nrf5x-command-line-tools android-platform-tools osxfuse"
